...
class SAPIENVisionDataset(data.Dataset):
    ...
    def __init__(self, category_types, data_features, \
            ...
            no_true_false_equal=False, no_aug_neg_data=True, only_true_data=False, contrastive_dir_p=None, constrastive_dir_n=None):
    ...
    def __getitem__(self, index):
        ...
        if any(feat in ['scene_pc_cam', 'scene_pc_pxids', 'gt_applicable_pc', 'gt_possible_pc', 'gt_object_pc'] for feat in self.data_features):
        ...
        for feat in self.data_features:
            if feat == 'rgb':
                ...
                # out = torch.from_numpy(robot_p).unsqueeze(0)
